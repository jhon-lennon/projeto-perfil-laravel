...
@section('home')
    ...
    <div class="col-3 text-right p-3">
       ...
       <h1>Meu Perfil</h1>
        <p><img src="assets\sombra.jpg" style="border-radius: 50px; height: 150px;  width: 150px;"></p>
     ...
     {{--  <p>Ultimo login:{{{{$usuario->Ultiomo_Login}}}}</p>--}}
       ...
       <div class="my-2">
        ...
        <div class="alert alert-warning text-center">{{$alerta}} <a href="{{route('excluir_conta')}}"class="alert-link">Confirmar</a> | <a href="{{route('perfil')}}"class="alert-link">Cancelar</a></div>
